			...
			<div class="resource-banner__form-wrap-outer">
				<div class="wrap">
					<div class="resource-banner__form-wrap">
						...
						<?php endif; ?>
						<?php if ( $_COOKIE['user-has-submitted'] == 1 ) : ?>
							<span class="button subscribed-button">
								<a href="<?php echo $the_file; ?>" target="_blank" download="">DOWNLOAD NOW</a>
							</span>
						<?php else : ?>
							<?php gravity_form( $form_id, false, false, $display_inactive = false, $field_values = array( 'download_url' => $perm_link ), $ajax = true, $tabindex ); ?>
						<?php endif; ?>
					</div>
				</div>
			</div>
			...
			<div class="single-resource__inner">
                ...
                <?php if ( empty( $bg_image ) ): ?>
                    <div class="resource-banner__form-wrap">
		                ...
		                <?php else : ?>
			                <?php gravity_form( $form_id, false, false, $display_inactive = false, $field_values = array( 'download_url' => $perm_link ), $ajax = false, $tabindex ); ?>
		                <?php endif; ?>
                    </div>
                <?php endif; ?>
