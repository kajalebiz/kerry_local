...
if ( rgblank(  $args['logged_in_message'] ) ) {
    ...
    $logged_in_message = $args['logged_in_message'];
    ...
    $logged_in_message = str_replace( '{home_url}', '<a href="' . esc_attr( site_url() ) . '" title="' . esc_attr__( 'Home', 'gravityformsuserregistration' ) . '">' . esc_html__( 'Continue', 'gravityformsuserregistration' ) . '</a>', $logged_in_message );
