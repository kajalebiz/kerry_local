...
<div class="woocommerce_account_subscriptions">
	...
	<thead>
		<tr>
			...
			<th class="subscription-start-date order-date woocommerce-orders-table__header woocommerce-orders-table__header-order-date woocommerce-orders-table__header-subscription-start-date"><span class="nobr"><?php echo esc_html_x( 'Start Date', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
			<th class="subscription-next-payment order-date woocommerce-orders-table__header woocommerce-orders-table__header-order-date woocommerce-orders-table__header-subscription-next-payment"><span class="nobr"><?php echo esc_html_x( 'Renewal Date', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
	...
	<?php foreach ( $subscriptions as $subscription_id => $subscription ) : ?>
		<tr class="order woocommerce-orders-table__row woocommerce-orders-table__row--status-<?php echo esc_attr( $subscription->get_status() ); ?>">
			...
			<td class="subscription-start-date order-date woocommerce-orders-table__cell woocommerce-orders-table__cell-subscription-start-date woocommerce-orders-table__cell-order-date" data-title="<?php echo esc_attr_x( 'Start Date', 'table heading', 'woocommerce-subscriptions' ); ?>">
                            <?php echo esc_attr( $subscription->get_date_to_display( 'start_date' ) ); ?>
			</td>
			<td class="subscription-next-payment order-date woocommerce-orders-table__cell woocommerce-orders-table__cell-subscription-next-payment woocommerce-orders-table__cell-order-date" data-title="<?php echo esc_attr_x( 'Next Payment', 'table heading', 'woocommerce-subscriptions' ); ?>">
				<?php // echo $subscription->data['schedule_end']->date("M. d, Y"); ?>
	...
	<?php else : ?>
		<p class="no_subscriptions woocommerce-message woocommerce-message--info woocommerce-Message woocommerce-Message--info woocommerce-info">
			<?php if ( 1 < $current_page ) :
				...
				esc_html_e( "Looks like you don’t have any subscriptions yet!", 'woocommerce-subscriptions' );
				?>
				<a class="woocommerce-Button button" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
					<?php esc_html_e( 'View Resources', 'woocommerce-subscriptions' ); ?>
				</a>
			<?php
		endif; ?>
		</p>
