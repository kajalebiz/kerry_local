...
/*
Template Name: Journey Map Managers
 */
...
add_action( 'objectiv_page_content', 'obj_jmm_page_sections' );
function obj_jmm_page_sections() {
	obj_jmm_jump_nav();
	obj_jmm_intro_content();
	obj_jmm_angled_tabs();
	obj_jmm_what_youll_get();
	obj_jmm_footer_form();
}

function obj_jmm_jump_nav() {
...
function obj_jmm_intro_content() {
...
function obj_jmm_angled_tabs() {
	$tab_content  = get_field( 'our_research_reports_tabs' );
	$sec_title    = get_field( 'our_research_reports_section_title' );
	$bottom_image = get_field( 'our_research_reports_bottom_image' );
...
function obj_jmm_what_youll_get() {
