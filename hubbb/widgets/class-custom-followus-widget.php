...
add_action( 'widgets_init', 'hubbb_followus_widget' );

/**
 * Register the Follow Us Widget
 */
function hubbb_followus_widget() {
...
class Followus extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
                'followus', // Base ID
                __( 'Hubbb - Follow Us', 'hubbb' ), // Name
                array('description' => __( 'Custom follow us widget', 'hubbb' )) // Args
        );
    }
...
<?php
    ...
    ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'hubbb' ); ?></label> 
