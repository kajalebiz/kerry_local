...
/*
Template Name: Host Your Own Experience Design
*/
...
add_action( 'objectiv_page_content', 'obj_host_your_own_ed_page_sections' );
function obj_host_your_own_ed_page_sections() {

	obj_host_your_own_ed_jump_nav();
	obj_hyo_ed_angled_tabs();
	obj_host_your_own_ed_leaders();
	obj_host_your_own_ed_cta();
}

function obj_host_your_own_ed_jump_nav() {
...
function obj_hyo_ed_angled_tabs() {
	$tab_content = get_field( 'why_host_your_own_ed_tabs' );
	$sec_title   = get_field( 'why_host_your_own_ed_section_title' );
...
function obj_host_your_own_ed_leaders() {
	$staff_title = get_field( 'host_your_own_ed_staff_title' );
	$staff       = get_field( 'staff_for_this_host_your_own_ed' );
	$sec_id      = get_field( 'host_your_own_ed_staff_sec_id' );
...
function obj_host_your_own_ed_cta() {
